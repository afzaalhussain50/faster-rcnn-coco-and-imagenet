...
import pandas as pd
merged_ques_facts_df = pd.read_csv("rel_type_df.csv")  
...
for epoch in tqdm(range(1, epochs+1)):
    ...
    tqdm.write(f'Training loss: {loss_train_avg}'); print(f'Training loss: {loss_train_avg}')
    
    val_loss, predictions, true_vals = evaluate(dataloader_validation)
    val_f1 = f1_score_func(predictions, true_vals)
    tqdm.write(f'Validation loss: {val_loss}'); print(f'Validation loss: {val_loss}')
    tqdm.write(f'F1 Score (Weighted): {val_f1}'); print(f'F1 Score (Weighted): {val_f1}')
