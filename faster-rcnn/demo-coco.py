...
def parse_args():
    ...
    parser.add_argument('--image_dir', dest='image_dir',
                        ...
                        default="/home/seecs/afzaalhussain/thesis/fvqa-data/new_dataset_release/images")
...
if __name__ == '__main__':
    ...
    # coco_classes
    # having issue with classes and indexes
    ...
    for detection_file in detections_file_path:
        ...
        coco_faster_rnn_results = {'index' : indexes_, 'labels' : labels_}
        detections_json['coco-faster-rcnn'] = coco_faster_rnn_results
        print("detections_json['coco-faster-rcnn'] ", detections_json['coco-faster-rcnn'])
